package com.zq.wx.mp.controller;
...
public class WxMenuController {
    ...
    // 如果报错如下：
    // 错误代码：45064,
    // 错误信息：no permission to use weapp in menu
    // 小程序必须关联公众号
    // 登陆公众号后台，左侧小程序管理，添加关联即可
    @GetMapping("/create")
    public String menuCreate(@PathVariable String appid) throws WxErrorException {
        // 区分appid，后台公众号跳转后台小程序，前中台公众号跳转前中台小程序
        WxMenu menu = buildMenu(appid);
